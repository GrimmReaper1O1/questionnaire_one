...
if ($_SESSION['administrator']['root'] == 1) {
  ...
  if (isset($_GET['alter'])) {
    $_SESSION['siteSettings'] = $cms->getMember()->selectStyle($_GET['alter']);
    $_SESSION['update'] = $_GET['alter'];
  }
  ...
  if (!isset($_SESSION['siteSettings']['pombw'])) {
    ...
    $_SESSION['siteSettings']['enableMovingBars']                        =  1;
    $_SESSION['siteSettings']['disableMovingBars']                        =  0;
    ...
    $_SESSION['siteSettings']['tWritting']                        = 'rgb(255,255,255)';
    $_SESSION['siteSettings']['writting']                        = 'rgb(255,255,255)';
    $_SESSION['siteSettings']['mboc']                       = 'rgb(0,0,0)';
    ...
    $arry['siteSettings'] =  $_SESSION['siteSettings'];
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['saveChanges'])) {
      ...
      if (!isset($_SESSION['update'])) {
        ...
        $cms->getMember()->saveUpdatedSiteSettings($_SESSION['update']);
    ...
    if (isset($_POST['submit0'])) {
      ...
      if (isset($_POST['enableMovingBars']) && isset($_POST['disableMovingBars'])) {
        $eDECheck = 1;
      } elseif (isset($_POST['enableMovingBars']) && !isset($_POST['disableMovingBars'])) {
        $_SESSION['siteSettings']['enableMovingBars'] = 1;
        $_SESSION['siteSettings']['disableMovingBars'] = 0;


      } elseif (!isset($_POST['enableMovingBars']) && isset($_POST['disableMovingBars'])) {
        $_SESSION['siteSettings']['disableMovingBars'] = 1;
        $_SESSION['siteSettings']['enableMovingBars'] = 0;
      ...
      if (isset($_POST['dls']) && isset($_POST['els'])) {
        ...
        $_SESSION['siteSettings']['dls'] = 0;
        $changel = 1;
        if (isset($_SESSION['siteSettings']['leftSBTemp'])) {
      ...
      if (isset($_POST['ers']) && isset($_POST['drs'])) {
        ...
        if (isset($_SESSION['siteSettings']['rightSBTemp'])) {
      ...
      if (($_POST['mbocr'] != '' && $_POST['mbocg'] != '' && $_POST['mbocb'] != '') ) {
        ...
        if ($_POST['writingr'] != '' && $_POST['writingg'] != '' && $_POST['writingb'] != '') {
          ...
          if ($_POST['writingr'] <= 255 && $_POST['writingr'] >= 0 && $_POST['writingg'] <= 255 && $_POST['writingg'] >= 0 && $_POST['writingb'] <= 255 && $_POST['writingb'] >= 0) {
            ...
            $_SESSION['siteSettings']['writting'] = 'rgb(' . $_POST['writingr'] . ',' .  $_POST['writingg'] . ',' . $_POST['writingb'] . ')';
          }
          ...
          if ($_POST['tWritingr'] != '' && $_POST['tWritingg'] != '' && $_POST['tWritingb'] != '') {
            ...
            if ($_POST['tWritingr'] <= 255 && $_POST['tWritingr'] >= 0 && $_POST['tWritingg'] <= 255 && $_POST['tWritingg'] >= 0 && $_POST['tWritingb'] <= 255 && $_POST['tWritingb'] >= 0) {
              ...
              $_SESSION['siteSettings']['tWritting'] = 'rgb(' . $_POST['tWritingr'] . ',' .  $_POST['tWritingg'] . ',' . $_POST['tWritingb'] . ')';
            }
                ...
                if ($_POST['mbcr'] != '' && $_POST['mbcg'] != '' && $_POST['mbcb'] != '') {
                  ...
                  if ($_POST['pombw'] != '') {
                    ...
                    if ($_POST['pombw'] <= 100 && $_POST['pombw'] >= 0) {
                      if ((($_POST['pombw'] % 2) != 1 && $_POST['porsw'] == '' && $_POST['polsw'] =='') || (((intval($_POST['pombw']) + intval($_POST['polsw']) + intval($_POST['porsw'])) == 100) && $_SESSION['siteSettings']['els'] == 1 && $_SESSION['siteSettings']['ers'] == 1)
                      ...
                      || ($_POST['pombw'] != '' && $_POST['polsw'] == '' && $_POST['porsw'] == ''))
                      {
                        ...
                        || ($_POST['porsw'] != '' && $_POST['polsw'] == '' && $_POST['pombw'] != '') || ($_POST['polsw'] != '' && $_POST['porsw'] == '' && $_POST['pombw'] != '')) {
                          ...
                          $numeral = ((100 - ($_POST['pombw']))/2);
                          $_SESSION['siteSettings']['porsw'] = $numeral;
                          $_SESSION['siteSettings']['polsw'] = $numeral;
                          $_SESSION['siteSettings']['pombw'] = $_POST['pombw'];

                        } elseif ($_POST['pombw'] >= 70 && $_SESSION['siteSettings']['dls'] == 0 && $_SESSION['siteSettings']['drs'] == 1) {
                          $numeral = (100 - ($_POST['pombw']));
                          $_SESSION['siteSettings']['polsw'] = $numeral;
                          $_SESSION['siteSettings']['pombw'] = $_POST['pombw'];

                        } elseif ($_POST['pombw'] >= 70 && $_SESSION['siteSettings']['dls'] == 1 && $_SESSION['siteSettings']['drs'] == 0) {
                          $numeral = (100 - ($_POST['pombw']));
                          $_SESSION['siteSettings']['porsw'] = $numeral;
                          $_SESSION['siteSettings']['pombw'] = $_POST['pombw'];
                      ...
                      $error .= "YOU CANNOT ENTER A WIDTH OF MORE THAN ONE HUNDRED PERCENT FOR YOUR MAIN BODY NOR BELOW AND IF ENTERED ALONE MUST BE AN EVEN NUMBER.<BR>";
                  ...
                  if ($_POST['porsw'] !== '' && $_POST['polsw'] !== '' && $_POST['pombw'] === '' && intval($_POST['porsw']) < 31 && intval($_POST['polsw']) < 31) {
                    $_SESSION['siteSettings']['pombw'] = 100 - (intval($_POST['porsw']) + intval($_POST['polsw']));
                  }
                    ...
                    if ($_POST['polsw'] <= 30 && $_POST['polsw']  >= 0) {
                      ...
                      ($_POST['porsw'] != '' && $_POST['polsw'] != '' && $_POST['pombw'] == '' && $_SESSION['siteSettings']['els'] == 1 && $_SESSION['siteSettings']['ers'] == 1) || ($_POST['polsw'] !== '' && $_POST['pombw'] != '' && $_SESSION['siteSettings']['els'] == 1)) {
                        ...
                        if ($_POST['polsw'] != '' && $_POST['pombw'] == '' && $_POST['porsw'] != '') {
                          echo "<div class='centeredText'>goal!</div>";
                  ...
                  if ($_POST['hobbip'] !== '') {
                    if ($_POST['hobbip'] <= 400 && $_POST['hobbip']  >= 30 ) {
                      if ($_SESSION['siteSettings']['enableMovingBars'] == 0 && $_POST['hobbip'] <= 120) {
                        $arry['siteSettings']['hobbip'] = $_POST['hobbip'];
                        $_SESSION['siteSettings']['hobbip'] = $_POST['hobbip'];


                      } elseif ($_SESSION['siteSettings']['disableMovingBars'] == 0) {
                    ...
                    try {
                      ...
                      if ($error2 === '') {
                        ...
                        if ($_SESSION['siteSettings']['mabp'] != '') {
                          ...
                          if (unlink("../uploads/" . $_SESSION['siteSettings']['mabp'])) { } else { unlink("../uploads/" . $_SESSION['siteSettings']['mabp']); };

                        }
                        $_SESSION['siteSettings']['mabp'] = $filename;
                      }
                    } catch (Error $e) {
                      $eWF= 1;
                    }
                    ...
                    try {
                      ...
                      if ($error2 === '') {
                        ...
                        if ($_SESSION['siteSettings']['cbp'] != '') {
                          ...
                          if (unlink("../uploads/" . $_SESSION['siteSettings']['cbp'])) {} else { unlink("../uploads/" . $_SESSION['siteSettings']['cbp']); };
                        }
                        $_SESSION['siteSettings']['cbp'] = $filename;
                    ...
                    try {
                      ...
                      if ($error2 === '') {
                        ...
                        if ($_SESSION['siteSettings']['mbp'] != '') {
                          ...
                          if (unlink("../uploads/" . $_SESSION['siteSettings']['mbp'])) {} else { unlink("../uploads/" . $_SESSION['siteSettings']['mbp']); };
                        }
                        $_SESSION['siteSettings']['mbp'] = $filename;
                  ...
                  if ($_POST['coibr'] != '' && $_POST['coibg'] != '' && $_POST['coibb'] != '') {
                    ...
                    if ($_POST['cotiibr'] != '' && $_POST['cotiibg'] != '' && $_POST['cotiibb'] != '') {
                      ...
                      if ($_POST['cotiibr'] <= 255 && $_POST['cotiibr'] >= 0 && $_POST['cotiibg'] <= 255 && $_POST['cotiibg'] >= 0 && $_POST['cotiibb'] <= 255 && $_POST['cotiibb'] >= 0) {
                        ...
                        $_SESSION['siteSettings']['cotiib'] = "rgb(" . $_POST['cotiibr'] . "," . $_POST['cotiibg'] . "," . $_POST['cotiibb'] . ")";
                      }
                          ...
                          if ($_POST['bcr'] != '' && $_POST['bcg'] != '' && $_POST['bcb'] != '') {
                                ...
                                try {
                                  ...
                                  if ($error2 === '') {
                                    ...
                                    if ($_SESSION['siteSettings']['bposa'] != '') {
                                      ...
                                      if (unlink("../uploads/" . $_SESSION['siteSettings']['bposa'])) {} else { unlink("../uploads/" . $_SESSION['siteSettings']['bposa']); };
                                    }
                                    $_SESSION['siteSettings']['bposa'] = $filename;
                            ...
                            if (isset($_POST['submit3'])) {
                              ...
                              if ($_POST['qbcr'] != '' && $_POST['qbcg'] != '' && $_POST['qbcb'] != '') {
                                      ...
                                      try {
                                        ...
                                        if ($error2 === '') {
                                          ...
                                          if ($_SESSION['siteSettings']['bpota'] != '') {
                                            ...
                                            if (unlink("../uploads/" . $_SESSION['siteSettings']['bpota'])) {} else { unlink("../uploads/" . $_SESSION['siteSettings']['bpota']); };
                                          }
                                          $_SESSION['siteSettings']['bpota'] = $filename;
                                ...
                                $arry['remidainingHeight2'] = intval($arry['remainingHeight'] - (floatval($arry['remainingHeight']) * 0.6));
                                ...
                                $_SESSION['siteSettings']['siteH2'] = '<span style="font-size: ' . $height2 . 'px; font-weith: bold; colour: ' . $_SESSION['siteSettings']['tWritting'] . ';">' . $_SESSION['siteSettings']['siteH'] . '</span>';
                                ...
                                if (isset($_SESSION['siteSettings'])) {
                                  ...
                                  $_SESSION['siteSettings']['mabpp1'] =   '../uploads/' .  $_SESSION['siteSettings']['mabp'];
                                  $_SESSION['siteSettings']['cbpp1'] =    '../uploads/' .  $_SESSION['siteSettings']['cbp'];
                                  $_SESSION['siteSettings']['mbpp1'] =    '../uploads/' .  $_SESSION['siteSettings']['mbp'];
                                  $_SESSION['siteSettings']['bposap1'] =  '../uploads/' .  $_SESSION['siteSettings']['bposa'];
                                  $_SESSION['siteSettings']['bpotap1'] =  '../uploads/' .  $_SESSION['siteSettings']['bpota'];
                                  ...
                                  <div class="mainbody">
                                    ...
                                    <div style="width: 80%; margin: 0 auto;" class="centeredText">
                                      ...
                                      <div class="centeredText">
                                        <h4>
                                          Please name the profile and submit to save changes to test style.
                                        </h4>
                                      </div>
                                      <form action="colourChangePage.php" method="POST">
                                        <div class="margin40">
                                          <input style="width: 100%" type="text" name="info" value="<?= $_SESSION['siteSettings']['profile_name'] ?? '' ?>">
                                        </div>
                                            ...
                                            <div style="border: 10px solid black; width: 700px; height: 400px;">
                                              ...
                                              <div style="display: block; width: 700px; height 400px; ">
                                                ...
                                                <div style=" color: white; height: <?= $arry['siteSettings']['hobbip2'] ?>px;    ">
                                                  <div style=" <?php if (isset($_SESSION['siteSettings']['ecb']) && $_SESSION['siteSettings']['ecb'] == 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]["cbpp1"] ?? ""?>');   background-size: contain; background-repeat: no-repeat; <?php } ?>  float: left; display: inline-block; border-bottom: 3px solid <?= $_SESSION['siteSettings']['lBarc'] ?? 'black' ?>; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; width: <?= $_SESSION['siteSettings']['polsw'] ?>%;  background-color: <?php if ($_SESSION['siteSettings']['els'] == 1 && $_SESSION['siteSettings']['efhb'] == 1) { echo  $_SESSION['siteSettings']['lBarc'] . '; border-bottom: 3px solid ' . $_SESSION['siteSettings']['lBarc'] ; } else { echo $_SESSION['siteSettings']['tc']; } ?>;">
                                                  </div>


                                                  <div style="<?php if ($_SESSION['siteSettings']['dmbpb'] == 0) { ?>background-image: url('<?= $_SESSION["siteSettings"]['mbpp1'] ?? '' ?>'); background-size: contain; background-repeat: no-repeat; <?php } ?>  float: left; display: inline-block; width: <?= $_SESSION['siteSettings']['pombw'] ?>%; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; text-align: center; background-color: <?= $_SESSION['siteSettings']['tc'] ?>; border-bottom: 3px solid <?= $_SESSION['siteSettings']['mboc'] ?? 'black' ?>; color: <?= $_SESSION['siteSettings']['tWritting'] ?? '' ?> !important;"><?= $_SESSION['siteSettings']['siteH2'] ?? ''  ?>

                                                  </div>
                                                  <div style="float: left; display: inline-block; position: relative; border-bottom: 3px solid <?= 'black' ?>;  z-index: 2; width: <?= $_SESSION['siteSettings']['porsw'] ?>%; background-color: <?php if ($_SESSION['siteSettings']['ers'] == 1 && $_SESSION['siteSettings']['efhb'] == 1) { echo $_SESSION['siteSettings']['rSideColour'] . '; border-bottom: 3px solid ' . $_SESSION['siteSettings']['rSideColour'] ; } else { echo  $_SESSION['siteSettings']['tc']; } ?>; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; ">
                                                  </div>



                                                </div>
                                                <div style="float: left; width: <?= $_SESSION['siteSettings']['polsw'] ?>%; height: <?= $arry['remainingHeight']  ?>px; background-color: <?= $_SESSION['siteSettings']['lBarc'] ?>;">
                                                </div>
                                                <div style=" display: inline-block; float: left; width: <?= $_SESSION['siteSettings']['pombw'] ?>%; height: <?= $arry['remainingHeight']  ?>px; background-color: <?=  $_SESSION['siteSettings']['mbc'] ?>;">
                                                  <div style="color: <?= $_SESSION['siteSettings']['writting'] ?? '' ?> !important; <?php if ($_SESSION['siteSettings']['enableBackgroundPicture'] == 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]["mabpp1"] ?? "" ?>'); background-size: cover; background-repeat: no-repeat; <?php } ?> display: block;  width: 100%; height: <?= $arry['remainingHeight'] -36 ?>px; margin: 0 auto; overflow: hidden;">
                                                    <div style="text-align: center; height: <?= $arry['remainingHeight'] -36 ?>px; overflow: hidden;">
                                                      <p>
                                                        <a style="position: relative; color: <?= $_SESSION['siteSettings']['writting'] ?? '' ?> !important;" href="colourChange.php">Link colour</a><p><br>
                                                          <div style="text-align: justified !important; height: <?= $arry['remainingHeight'] -36 ?>px;"><p>Text.</p>
                                                          </div></div>
                                                          <div style="color: <?= $_SESSION['siteSettings']['writting'] ?? '' ?> !imporatant; position: relative;  width:100% height: 30px; text-align: center; background-color: <?=  $_SESSION['siteSettings']['mbc'] ?>;">-1-2-3-</div>
                                                        </div>
                                                      </div>



                                                      <div style="float: left; width: <?= $_SESSION['siteSettings']['porsw'] ?>%; height: <?= $arry['remainingHeight'] ?>px; background-color: <?= $_SESSION['siteSettings']['rSideColour']  ?>;">
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div style="display: block;">
                                                    ...
                                                    <form action="colourChangePage.php" method="POST">
                                                      <div style="padding-left: 70px;">
                                                        <div style="width: 20%;" class="flex" ><div ><label for="enableMovingBars">Enable moving bars:           </label>      </div>            <div style="padding-left: 35px;"><input type="checkbox" name="enableMovingBars" /> </div></div>
                                                        <div style="width: 20%;" class="flex" ><div ><label for="disableMovingBars">Disable moving bars:          </label>      </div>            <div style="padding-left: 35px;"><input type="checkbox" name="disableMovingBars" /> </div> </div>
                                                ...
                                                <div style="display: inline-flex; flex-flow: column wrap; justify-content: flex-start; flex-wrap: wrap; width: 400px; height: 1250px;">
                                                  <form action="colourChangePage.php" method="POST" enctype="multipart/form-data">
                                                    <div style="width: 100%; padding-left: 40px;">
                                                      <div style="display: block; padding-top: 18px;"><div><label  for="tWritting">Title text colour RGB:</label>           </div> <div style="height: 48px;"><div class="width50" > <div class="number"><input class="width100" type="number"  name="tWritingr" /></div><div class="number"> &nbsp; <input class="width100" type="number" name="tWritingg" /></div><div class="number"> &nbsp; <input class="width100" type="number"  name="tWritingb" />   </div>  </div> </div> </div>
                                                      <div style="display: block; padding-top: 18px;"><div><label  for="writting">Main text colour RGB:</label>           </div> <div style="height: 48px;"><div class="width50" > <div class="number"><input class="width100" type="number"  name="writingr" /></div><div class="number"> &nbsp; <input class="width100" type="number" name="writingg" /></div><div class="number"> &nbsp; <input class="width100" type="number"  name="writingb" />   </div>  </div> </div> </div>
                                                      ...
                                                      <div style="display: block; "  ><div style="line-height: 20px; padding-bottom: 15px;"><label  for="cbp">Corner banner picture:</label>                </div> <div style="padding-left: 15px; height: 48px;"><input type="file" name="cbp" />        </div> </div>
                                                      <div style="display: block; "  ><div style="line-height: 20px; padding-bottom: 15px;"><label  for="mbp">Main banner picture:</label>                  </div> <div style="padding-left: 15px; height: 48px;"><input type="file" name="mbp" >        </div></div>
                                                    </div>
                                              ...
                                              <div style="display: block; width: 1100px; height: 750px;">
                                                ...
                                                <div style="display: inline-flex; flex-flow: column wrap; justify-content: flex-start; flex-wrap: wrap; width: 1100px; height: 750px">
                                                  <div style="width: 700px; height 400px; border: 10px solid black;">
                                                    ...
                                                    <div style=" color: white; height: <?= $arry['siteSettings']['hobbip2'] ?>px;    ">
                                                      <div style=" <?php if (isset($_SESSION['siteSettings']['ecb']) && $_SESSION['siteSettings']['ecb'] == 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]["cbpp1"] ?? ""?>');   background-size: contain; background-repeat: no-repeat; <?php } ?>  float: left; display: inline-block; border-bottom: 3px solid <?= $_SESSION['siteSettings']['mbc'] ?? 'black' ?>; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; width: <?= $_SESSION['siteSettings']['polsw'] ?>%;  background-color: <?php if ($_SESSION['siteSettings']['els'] == 1 && $_SESSION['siteSettings']['efhb'] == 1) { echo  $_SESSION['siteSettings']['lBarc'] . '; border-bottom: 3px solid ' . $_SESSION['siteSettings']['lBarc'] ; } else { echo $_SESSION['siteSettings']['tc']; } ?>;">
                                                      </div>


                                                      <div style="<?php if ($_SESSION['siteSettings']['dmbpb'] != 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]['mbpp1'] ?? '' ?>'); background-size: contain; background-repeat: no-repeat; <?php } ?>  float: left; display: inline-block; width: <?= $_SESSION['siteSettings']['pombw'] ?>%; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; text-align: center; background-color: <?= $_SESSION['siteSettings']['tc'] ?>; border-bottom: 3px solid <?= $_SESSION['siteSettings']['mboc'] ?? 'black' ?>; color: <?= $_SESSION['siteSettings']['tWritting'] ?? '' ?> !important;"><?= $_SESSION['siteSettings']['siteH2'] ?? '' ?>
                                                    ...
                                                    <div style=" display: inline-block; float: left; width: <?= $_SESSION['siteSettings']['pombw'] ?>%; height: <?= $arry['remainingHeight']  ?>px; background-color: <?=  $_SESSION['siteSettings']['mbc'] ?>;">
                                                      <div>
                                                        <div style="<?php if ($_SESSION['siteSettings']['enableBackgroundPicture'] == 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]["bposap1"] ?? "" ?>'); width: 100%; background-repeat: no-repeat; <?php } ?> display: block; height: <?= $arry['remainingHeight']?>px; background-size: cover; margin: 0 auto; background-color: <?= $_SESSION['siteSettings']['cospb'] ?? '' ?>; overflow: hidden;">
                                                            ...
                                                            <div style="position: relative; height: 85%; width: 100%; margin: 0 auto;">
                                                              <div style="text-align: center; height: 50%; ">
                                                                <div style="margin: 0 auto; width: 80%;">
                                                                  <img style="height: <?= 150 ?>px;" src="../images/plants dancing.jpg" />
                                                  ...
                                                  id          <form action="colourChangePage.php" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div style="display: block; width: 1600px; height: 700px;">
                                                  ...
                                                  <div style="display: inline-flex; flex-flow: column wrap; justify-content: flex-start; flex-wrap: wrap; width: 700px; height: 700px">
                                                    <div style="width: 700px; height 400px; border: 10px solid black;">
                                                      ...
                                                      <div style=" color: white; height: <?= $arry['siteSettings']['hobbip2'] ?>px;    ">
                                                        <div style=" <?php if (isset($_SESSION['siteSettings']['ecb']) && $_SESSION['siteSettings']['ecb'] == 1) { ?>background-image: url('<?= $_SESSION["siteSettings"]["cbpp1"] ?? ""?>');   background-size: contain; background-repeat: no-repeat; <?php } ?>  float: left; display: inline-block; border-bottom: 3px solid <?= 'black' ?>; height:  <?= $arry['siteSettings']['hobbip2'] -2 ?>px; width: <?= $_SESSION['siteSettings']['polsw'] ?>%;  background-color: <?php if ($_SESSION['siteSettings']['els'] == 1 && $_SESSION['siteSettings']['efhb'] == 1) { echo  $_SESSION['siteSettings']['lBarc'] . '; border-bottom: 3px solid ' . $_SESSION['siteSettings']['lBarc'] ; } else { echo $_SESSION['siteSettings']['tc']; } ?>;">
                                                        </div>
                                                      ...
                                                      <div style=" color: <?= $_SESSION['siteSettings']['cotiqp'] ?? 'black' ?> !important; display: inline-block; float: left; width: <?= $_SESSION['siteSettings']['pombw'] ?>%; height: <?= $arry['remainingHeight']  ?>px; background-color: <?=  $_SESSION['siteSettings']['mbc'] ?>;">
                                                        <div style="display: block; height: <?= $arry['remainingHeight'] ?>px; width: 100%; margin: 0 auto; background-color: <?= $_SESSION['siteSettings']['coqb'] ?? '' ?>; <?php if ($_SESSION['siteSettings']['enableBackgroundPicture'] == 1) { ?>   background-image: url('<?= $_SESSION["siteSettings"]["bpotap1"] ?? "" ?>'); background-size: cover; background-repeat: no-repeat;<?php } ?> overflow: hidden;">
