...
<?php
	...
	<form action="multiplication.php?numbers=yes" method="POST">
...
if (isset($_GET['numbers'])) {
	...
	?>
	<div class="margin50">
	<form action="multiplication.php?calculate=yes" method="POST">
	<?php
	...
	if ($bottomLen < $topLen) {
		...
		$_SESSION['bottom' . $i] = "<b>x</b>" . '<b style="color: '. $_SESSION['layoutOfSite']['mbc'].'">-</b>' . $space . $s2 . strval($bottom) .  "<br>";
			
		} else {
		$_SESSION['bottom' . $i] = "<b>x</b>" . $space . $s2 . strval($bottom) .  "<br>";
		}
		if ($neg['1' . $i] == 0 && $neg['2' . $i] == 1) {
		$_SESSION['top' . $i] =  '<b style="color: '. $_SESSION['layoutOfSite']['mbc'].'">x</b>' . '<b style="color: '. $_SESSION['layoutOfSite']['mbc'].'">-</b>' . $space . strval($top) . "<br>";	
		} else {
		$_SESSION['top' . $i] =  '<b style="color: '. $_SESSION['layoutOfSite']['mbc'].'">x</b>' . $space . strval($top) . "<br>";
		}
	...
	<input type="submit" value="CHECK QUESTIONS!">
</div>	
</form>
<form action="multiplication.php?reset=yes" method="POST">
	<div class="centeredText">	
